...
<header class="common-header">
    ...
    <div class="search-area">
      <div class="search-area-content">
        <a class="btn btn-default close-btn" onclick="toggleSearch()" href="#"><i class="fa fa-close"></i></a>
        <div class="search-input">
            <input class="form-control" type="text" id="search-input"/> 
            <p><?php echo __('Поиск по продукции:'); ?></p>
        </div>
...
<?php $img = get_the_post_thumbnail($queried->ID, 'full', ['class' => 'post-thumbnail']); echo $img; ?>
